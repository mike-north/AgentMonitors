...
| 3   | **Mike is User #1 (Wave 1):** he builds an oFocus monitor standalone (outside any plugin) to prove the runtime works.                                                                                                                                                                                 | Tight, information-rich feedback loop before exposing anyone else.                                     |
